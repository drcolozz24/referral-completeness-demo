...
**RACGP — the profession's referral standard.** The *Standards for general practices* (5th edition), criterion GP2.3 indicator B, require that "referral letters are legible and contain all required information", and list that information; the criterion is assessed at practice accreditation. The RACGP's guide *Referring to other medical specialists* (2019) restates the requirements with worked examples of referral wording and the Medical Board's three principles for good referrals. Sources: [RACGP Criterion GP2.3](https://www.racgp.org.au/running-a-practice/practice-standards/standards-5th-edition/standards-for-general-practices-5th-ed/general-practice-standards/gp-standard-2/criterion-gp2-3-engaging-with-other-services); *Referring to other medical specialists*, RACGP, 2019.
